...
function Header({ textcolor = "#28251F" }) {
  ...
  const handleLogoClick = (e) => {
    e.preventDefault();
    // Always close the menu when logo is clicked
    setIsMenuOpen(false);
  ...
  return (
    <>
      <header
        className={`fixed left-0 right-0 z-50 w-full px-4 py-4 flex items-center h-[49px] transition-transform duration-300 ease-in-out ${
          isScrolled ? "scrolled" : ""
