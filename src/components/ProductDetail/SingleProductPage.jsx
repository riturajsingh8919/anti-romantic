...
const SingleProductPage = ({ productSlug }) => {
  ...
  return (
    <>
      ...
      <div className="lg:min-h-screen bg-[url('/store/store-sec-bg.png')] pt-[64px] md:pt-0">
          ...
          (() => {
              ...
              allVideos.slice(0, 2).forEach((video, videoIndex) => {
                renderElements.push(
                  <div
                    ...
                    className="relative w-full h-full md:h-screen flex"
                  >
                    <video
                      src={video.url}
                      loop
            ...
            if (textItems.length > 0) {
              ...
              renderElements.push(
                <div
                  key={`text-0`}
                  className="relative w-full h-full md:h-[90vh] flex"
                >
