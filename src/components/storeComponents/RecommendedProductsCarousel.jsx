              ...
              >
                ...
                >
                  ...
                  <div className="relative bg-gray-100 mb-6 overflow-hidden aspect-[3/4]">
                    ...
                    {productImages[product.id]?.hasVideo &&
                    productImages[product.id]?.normalVideo ? (
                      <video
                        src={productImages[product.id].normalVideo.url}
                      ...
                      <img
                        src={
                          productImages[product.id]?.normalImage?.url ||
                          product.image
                        }
                        alt={
                          productImages[product.id]?.normalImage?.alt ||
                          product.name
                        }
                        className="w-full h-full object-cover group-hover:opacity-0 transition-opacity duration-0"
                        draggable={false}
                    ...
                    {/* Hover Image */}
                    {productImages[product.id]?.hoverImage && (
                      <img
                        src={productImages[product.id].hoverImage.url}
                        alt={
                          productImages[product.id].hoverImage.alt ||
                          product.name
                        }
